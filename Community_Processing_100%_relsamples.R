...
for (subdir in subdirs) {
  ...
  setwd('/Users/m254284/Desktop/Neo4j_Projects/Img_events/ModOpt_bycalc/Integration_100%_regional_relsamples')
...
main_directory <- "/Users/m254284/Desktop/Neo4j_Projects/Img_events/ModOpt_bycalc/Iterations"
output_directory <- "/Users/m254284/Desktop/Neo4j_Projects/Img_events/ModOpt_bycalc/Integration_100%_regional_relsamples"
...
process_comms_file <- function(file_path, master) {
  ...
  comms_NE <- comms[comms$percentage_NE == "1", ]
...
nece_files <- list.files("/Users/m254284/Desktop/Neo4j_Projects/Img_events/ModOpt_bycalc/Integration_100%_regional_relsamples", pattern = "^NECE_comm_percentages_.*\\.csv$", full.names = TRUE)
...
# Set directories
integration_dir <- "/Users/m254284/Desktop/Neo4j_Projects/Img_events/ModOpt_bycalc/Integration_100%_regional_relsamples"
...
# Set directories
pathways_dir <- "/Users/m254284/Desktop/Neo4j_Projects/Img_events/ModOpt_bycalc/Integration_100%_regional_relsamples/Pathways_regional/NE_All"
output_dir <- "/Users/m254284/Desktop/Neo4j_Projects/Img_events/ModOpt_bycalc/Integration_100%_regional_relsamples/Pathways_regional"
...
#select which to use
scaled_master <- scaled_master_all
...
heatmap_plot <- ggplot(mean_intensity_per_cluster, aes(x = Cluster, y = Imgs, fill = MeanIntensity)) +
  ...
  labs(title = "Intensity vs All Samples",
       x = "Cluster",
       y = "Imaging Features",
...
# CORRELATION OF IMAGING FEATURES WITH PATHWAYS. not enough comms for this ----
library(dplyr)
library(tidyr)
